                ...
                <div className="row">
                    <div className="col text-center">
                        ...
                        <table className="table">
                            <tbody>
                                <tr>
                                    <td className="text-end align-middle" colSpan={6}><a href="#" onClick={clear} className="btn btn-warning">Vaciar Carrito <LiaTrashAltSolid /></a></td>
                                </tr>
                                {cart.map(product =>
                                    <tr key={product.id}>
                                        ...
                                        <td className="text-end align-middle"><a href="#" onClick={() => {removeItem(product.id)}}><LiaTrashAltSolid /></a></td>
                                    </tr>
                                )}
                                <tr>
