    ...
    return (
        ...
        <div className="container mt-100">
            ...
            <div className="col-2 mt-5 align-self-star">
                ...
                <li
                    className={`list-group-item ${activeCategory === "" ? "active" : ""}`}
                    aria-current="true"
                >
                ...
                {categories.map((cat) => (
                    <li
                        key={cat}
                        className={`list-group-item ${activeCategory === cat ? "active" : ""}`}
                    >
                        <Link to={`/Store/${cat}`} onClick={() => handleFilterChange(cat)}>
                            {cat}
                        </Link>
                    </li>
                ))}
            ...
            <div className="col-10">
                ...
                <div className="col">
                    ...
                    <MDBDropdownMenu>
                        {categories.map((cat) => (
                            <MDBDropdownItem className={`m-2 text-center pe-auto ${activeCategory === cat ? "active" : ""}`}
